...
import { GameHud, GameStage } from '@/components/game'
...
function JigsawPuzzleGame() {
  ...
  const handleGameComplete = () => {
    // Completion UI is handled in-game by CompletionMessage
  }

  return (
    <GameStage title="传统拼图" rules={GAME_RULES} contentClassName="items-center">
