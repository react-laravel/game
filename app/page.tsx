...
const GAMES = [
  {
    id: 'monopoly',
    name: '地产棋局',
    description: '全屏棋盘 · 实时多人',
    icon: '🏙️',
  },
  { id: 'moon-dice', name: '月饼骰子', description: '博饼对局 · 六骰同摇', icon: '🎲' },
  {
    id: 'blackjack',
    name: '21 点',
    description: '全屏牌桌 · 坐庄/闲家',
    icon: '🃏',
  },
  { id: 'sliding-puzzle', name: '滑块拼图', description: '数字滑块 · 三档难度', icon: '🧩' },
  { id: 'picture-puzzle', name: '图片拼图', description: '拆图重排 · 可上传', icon: '🖼️' },
  { id: 'jigsaw-puzzle', name: '传统拼图', description: '拖拽拼合 · 自动吸附', icon: '🧩' },
  {
    id: 'shooting-range',
    name: '射击训练场',
  ...
  { id: 'bowling', name: '保龄球', description: '十局全场 · 3D 球馆', icon: '🎳' },
  { id: 'tetris', name: '俄罗斯方块', description: '街机机台 · 消行得分', icon: '🧱' },
  { id: '2048', name: '2048', description: '滑动合并 · 挑战 2048', icon: '🔢' },
  { id: 'snake', name: '贪吃蛇', description: '全屏街机 · 滑动转向', icon: '🐍' },
  { id: 'minesweeper', name: '扫雷', description: '三档难度 · 计时排雷', icon: '💣' },
