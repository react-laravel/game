...
export const mapConfigs: Record<ShootingMapId, MapConfig> = {
  indoor: {
    ...
    accent: '#9de8ff',
    fillLight: { color: '#eef8ff', intensity: 2.05, position: [0, 10, -20] },
  },
  outdoor: {
    id: 'outdoor',
    name: '户外靶场',
    ...
    background: '#87b8d8',
    fog: { color: '#b8d8ec', near: 65, far: 128 },
    hemisphere: { sky: '#e8f6ff', ground: '#4a7a48', intensity: 2.15 },
    directional: { color: '#fff0d8', intensity: 3.15, position: [14, 22, 8] },
