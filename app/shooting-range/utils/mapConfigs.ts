...
export const mapConfigs: Record<ShootingMapId, MapConfig> = {
  indoor: {
    ...
    hemisphere: { sky: '#f8fcff', ground: '#5a7282', intensity: 2.45 },
    directional: { color: '#ffffff', intensity: 3.15, position: [5, 16, 6] },
    floor: { color: '#4a6272', metalness: 0.14, roughness: 0.74 },
    grid: [80, 40, '#5a9cb0', '#456878'],
    accent: '#9de8ff',
    fillLight: { color: '#eef8ff', intensity: 2.45, position: [0, 10, -20] },
  },
  outdoor: {
    id: 'outdoor',
    name: '户外靶场',
    ...
    background: '#87b8d8',
    fog: { color: '#c8dce8', near: 102, far: 185 },
    hemisphere: { sky: '#e8f6ff', ground: '#4a7a48', intensity: 2.25 },
    directional: { color: '#fff0d8', intensity: 3.25, position: [14, 22, 8] },
