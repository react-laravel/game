...
export const mapConfigs: Record<ShootingMapId, MapConfig> = {
  indoor: {
    ...
    background: '#6a8a9e',
    fog: { color: '#7a9aae', near: 48, far: 92 },
    hemisphere: { sky: '#f8fcff', ground: '#5a7282', intensity: 2.15 },
    directional: { color: '#ffffff', intensity: 3.25, position: [5, 16, 6] },
    floor: { color: '#4a6272', metalness: 0.14, roughness: 0.74 },
    grid: [80, 40, '#5a9cb0', '#456878'],
    accent: '#9de8ff',
    fillLight: { color: '#eef8ff', intensity: 1.85, position: [0, 10, -20] },
  },
  outdoor: {
    id: 'outdoor',
    name: '户外靶场',
    ...
    background: '#6aafd4',
    fog: { color: '#a8d4ec', near: 70, far: 135 },
    hemisphere: { sky: '#e8f6ff', ground: '#4a7a48', intensity: 2.0 },
    directional: { color: '#fff4e0', intensity: 3.0, position: [14, 22, 8] },
    floor: { color: '#4a8448', metalness: 0.03, roughness: 0.94 },
    grid: [90, 45, '#4a7a4d', '#356338'],
    accent: '#c8e8ff',
    rimLight: { color: '#b8dcff', intensity: 0.65, position: [-10, 8, 12] },
  },
  warehouse: {
    id: 'warehouse',
    name: '工业仓库',
