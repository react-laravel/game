...
export const OUTDOOR_TIME_OPTIONS: OutdoorTimePreset[] = [
  ...
  },
  {
    ...
    hemisphere: { sky: '#1a2838', ground: '#304838', intensity: 0.88 },
    directional: { color: '#a8c0d8', intensity: 0.48, position: [-18, 10, -8] },
    rimLight: { color: '#7088a0', intensity: 0.32, position: [12, 5, 14] },
    fillLight: { color: '#ffe8c8', intensity: 1.05, position: [0, 4, -16] },
