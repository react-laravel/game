...
export const OUTDOOR_TIME_OPTIONS: OutdoorTimePreset[] = [
  ...
  },
  {
    ...
    hint: '金色时刻 · 暖色长影',
    background: '#c06038',
    fog: { color: '#d09860', near: 90, far: 165 },
    hemisphere: { sky: '#f0c898', ground: '#3e5c3a', intensity: 1.72 },
    directional: { color: '#ffd098', intensity: 2.38, position: [28, 12, -6] },
    rimLight: { color: '#f0a860', intensity: 0.86, position: [-14, 6, 8] },
    ...
    groundTint: '#4a6e40',
    grassTint: '#4a7648',
    horizonWash: { color: '#e09850', opacity: 0.34 },
    showRangeLights: false,
    targetReadabilityBoost: 0,
  },
  {
